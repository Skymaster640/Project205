...
#This import(^) prevents the project from working, but I don't know how to fix it.
import platform
...
def gameWindow():
    ...
    bg = ImageTk.PhtooImage(file = "./assets/background.png")
    ...
    flashNumberLabel = canvas2.create_text(400,screen_height/2.3,text="Waiting for other players to join...",font=("Chalkboard SE",30),fill="#32723")
